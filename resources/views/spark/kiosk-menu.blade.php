<aside>
    ...
    <ul class="nav flex-column mb-4 ">
        @if(isset($is_ajax) && !$is_ajax)
            <li class="nav-item ">
                <a class="nav-link" href="/spark/kiosk/#/announcements">
    ...
    18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
            ...
            <li class="nav-item ">
                <a class="nav-link" href="/spark/kiosk/#/metrics">
                    <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
    ...
    0-1.2-.2.8-1 1.3-2.4 1.3-3.8s0-2.7-1-3.8l1-.2z"></path>
            ...
            <li class="nav-item ">
                <a class="nav-link" href="/spark/kiosk/#/users">
                    <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
    ...
    6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z"></path>
        ...
        @endif
        <li class="nav-item ">
            <a class="nav-link @smb_active(spark/kiosk/crud/users)" href="/spark/kiosk/crud/users">
                <i class="fa fa-user icon-20 fa-lg fa-icon"></i>
                {{__('Users')}}
            </a>
        </li>
        <li class="nav-item ">
