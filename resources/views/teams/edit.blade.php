        ...
        <div class="card-body">
            {!! Form::model($team, ['url' => '/spark/kiosk/crud/teams/'.$team->id, 'method' => 'PUT']) !!}
                <div class="form-group row">
                    <label for="announcement" class="col-md-4 col-form-label text-md-right">Plan</label>
                    <div class="col-md-6">
                        {!! Form::select('plan', Laravel\Spark\Spark::teamPlans()->pluck('name', 'id'), null, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="action_text" class="col-md-4 col-form-label text-md-right">Total</label> 
                    <div class="col-md-6">
                        {!! Form::number('total', null, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="action_url" class="col-md-4 col-form-label text-md-right">Duration on days</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="offset-md-4 col-md-6">
                        {!! Form::submit('Add subscription', ['class'=>'btn btn-primary']) !!}
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
